...
const mentors = [
  ...
  },
  {
    ...
    photo: 'https://images.unsplash.com/photo-1543966888-7c1dc482a810?q=80&w=800&auto=format&fit=crop'
  },
  {
    name: 'Yuki Tanaka',
  ...
  },
  {
    ...
    photo: 'https://images.unsplash.com/photo-1541214113241-7f4bfaad6bed?q=80&w=800&auto=format&fit=crop'
  }
];
    ...
    <section id="mentors" className="relative py-20">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {mentors.map((m) => (
            <article key={m.name} className="group rounded-2xl border border-neutral-800 bg-neutral-900/40 p-5 transition hover:border-neutral-700">
              ...
              <div className="mt-4">
                ...
                <p className="mt-1 text-sm text-neutral-300">{m.title}</p>
